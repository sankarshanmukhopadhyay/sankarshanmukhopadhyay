---
layout: default
title: Portfolio Assurance Report — 2026-08-30
nav_exclude: true
search_exclude: true
---

# Portfolio Assurance Report — 2026-08-30

**Observed:** 2026-08-30T16:40:13Z  
...
### PAM-D3BF170E90CC: rahp-toolkit

- **Fingerprint:** `PF-9467E1566783`
...
### PAM-72020381D03C: rahp-toolkit

- **Fingerprint:** `PF-B62C61100AB3`
...
| ↳ `portfolio_contract` | required | `satisfied` |  | successful workflow evidence satisfies the configured freshness policy |
| ↳ `publication_integrity` | required | `satisfied` |  | successful workflow evidence satisfies the configured freshness policy |
| [rahp-toolkit](https://github.com/sankarshanmukhopadhyay/rahp-toolkit) | `assurance-toolkit` | **degraded** | 3 | 2/3 |
| ↳ `toolkit_validation` | required | `degraded` |  | latest completed workflow conclusion is failure |
